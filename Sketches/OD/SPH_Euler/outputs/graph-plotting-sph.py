...
density_gambel_20 = open("/Users/oluwoledelano/ECS_Development/flecs-in-docker/Sketches/OD/smooth_particle_hydrodynamics/outputs/Gambel_Density_ParticleNo=20.txt")
density_gambel_50 = open("/Users/oluwoledelano/ECS_Development/flecs-in-docker/Sketches/OD/smooth_particle_hydrodynamics/outputs/Gambel_Density_ParticleNo=50.txt")
...
ax_energy.hlines(y = energy[0,1], xmin=min(energy[:,0]), xmax=max(energy[:,0]), color = 'black', label = 'axvline - full height')
