...
data_path = os.path.join(root_folder, "outputs", "starter_fluid.txt")
save_pathpdf = os.path.join(root_folder, "outputs", f"transformed_Pe={Pe},Nodes={Nx}.pdf")
save_pathpng = os.path.join(root_folder, "outputs", f"transformed_Pe={Pe},Nodes={Nx}.png")
